...
<body>
    ...
    <div class="wrapper">
        ...
        <!--           THIS IS ADD BANNER Dynamic-->

        <!-- ========================================= HOME BANNERS ========================================= -->
        <?php
                                
             $query = "SELECT * FROM slider_add ";                   
            ...
            <div class="container">
                ...
                <div class="col-xs-12 col-lg-6 no-margin banner">
                    <a href="category-grid-2.html">
                        ...
                        <img class="banner-image" alt="" src="assets/images/blank.gif" data-echo="assets/images/banners/<?php echo $slider_img1; ?>" />
                    </a>
                </div>
                ...
                <div class="col-xs-12 col-lg-6 no-margin text-right banner">
                    <a href="category-grid-2.html">
                        ...
                        <img class="banner-image" alt="" src="assets/images/blank.gif" data-echo="assets/images/banners/<?php echo $slider_img2; ?>" />
                    </a>
                </div>
