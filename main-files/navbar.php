...
<div class="price">RS:<?php echo $product_prize; ?></div>
 ...
 <a class="close-btn" href="index.php?delete=<?php echo $product_id; ?>"></a>
<!--<a class="close-btn" href="index.php?delete='$p_id'"></a>-->
...
<!--          GET PRODUCT IN NAVBAR CART SECTION   -->
 <?php
 if(isset($_GET['delete'])){
    $product_id = $_GET['delete'];
   $query = "DELETE FROM cart WHERE p_id='$product_id'"; 
